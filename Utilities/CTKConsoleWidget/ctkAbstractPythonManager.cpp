...
void ctkAbstractPythonManager::initPythonQt(int flags)
{
  ...
  QObject::connect(PythonQt::self(), &PythonQt::systemExitExceptionRaised,
                   this, &ctkAbstractPythonManager::systemExitExceptionRaised);

  // Not required as the messages goes already to the Python console
  /*
  QObject::connect(PythonQt::self(), &PythonQt::pythonStdOut,
                   this, &ctkAbstractPythonManager::printStdout);
  QObject::connect(PythonQt::self(), &PythonQt::pythonStdErr,
                   this, &ctkAbstractPythonManager::printStderr);
  */
                                                       ...
                                                       bool appendParenthesis) const
{
  ...
  foreach(const QString& module, moduleList)
    {
    object = PyDict_GetItemString(dict, qPrintable(module));
